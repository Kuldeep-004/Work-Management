...
const AdvancedTaskTable = React.memo(
  ({
    ...
    const {
      ...
      user,
      tasksToUse,
      taskSort: currentTaskSort,
      taskSortOrder: currentTaskSortOrder,
      groupOrder,
      groupOrderLoaded,
    ...
    useEffect(() => {
      ...
      if (permanentScrollbarRef.current) {
        permanentScrollbarRef.current.addEventListener(
          "scroll",
          handlePermanentScroll,
        );
      }
      ...
      return () => {
        ...
        if (permanentScrollbarRef.current) {
          permanentScrollbarRef.current.removeEventListener(
            "scroll",
            handlePermanentScroll,
          );
        }
      ...
      `}</style>
        ...
        <div className="pt-4 bg-gray-50 min-h-screen">
          ...
          <div className="table-wrapper-no-scrollbar w-full" ref={tableRef}>
            <table
              className={`min-w-full divide-y divide-gray-200 ${isResizing ? "select-none" : ""}`}
              ...
              {!shouldGroup && (
                <thead className="border-b border-gray-200">
                  <tr>
                    {enableBulkSelection && (
                      <th
                        className="px-2 py-1 text-left text-sm font-normal bg-white tracking-wider select-none whitespace-nowrap border-r border-gray-200"
                      ...
                      return (
                        <th
                          ...
                          style={{
                            ...
                            background:
                              dragOverColumn === colId ? "#f0f6ff" : "white",
                            boxShadow:
              ...
              <tbody>
                {shouldGroup
                  ? (() => {
                      ...
                      return Object.entries(renderGroupedTasks)
                        .map(([group, groupTasks]) => {
                          // Only show groups and tasks if we haven't exceeded the limit
                          const tasksToShow = groupTasks.slice(
                            0,
                            Math.max(0, loadedTasksCount - totalTasksShown),
                          );
                          const shouldShowGroup =
                            totalTasksShown < loadedTasksCount &&
                          ...
                          return (
                            <React.Fragment key={group}>
                              ...
                              >
                                <td
                                  colSpan={
                                    getOrderedVisibleColumns().length +
                                    (viewType === "assigned" ||
                                    viewType === "admin"
                                      ? 2
                                      : 1) +
                              ...
                              {tasksToShow.map((task, idx) => (
                                <tr
                                  ...
                                  onDragStart={(e) =>
                                    handleRowDragStart(e, task._id)
                                  }
                                  onDragOver={(e) =>
                                    handleRowDragOver(e, task._id)
                                  }
                                  onDrop={(e) => handleRowDrop(e, task._id)}
                                  onDragEnd={handleRowDragEnd}
                                  style={{
                                    opacity:
                                      draggedTaskId === task._id ? 0.5 : 1,
                                  }}
                                >
                                  {enableBulkSelection && (
                                    <td
                                      className="px-2 py-1 text-sm font-normal align-middle bg-white border-r border-gray-200"
                                      style={{
                                        width: "48px",
                                        minWidth: "48px",
                                      }}
                                      ...
                                      switch (colId) {
                                        ...
                                        case "description":
                                          return (
                                            <td
                                              key={colId}
                                              className={`px-2 py-1 text-sm font-normal align-top bg-white border-0 ${!isLast ? "border-r border-gray-200" : ""}`}
                                              style={{
                                                verticalAlign: "top",
                                                width:
                                                  (columnWidths[colId] || 180) +
                                                  "px",
                                                minWidth:
                                                  (columnWidths[colId] || 180) +
                                                  "px",
                                        ...
                                        case "status":
                                          ...
                                          return (
                                            ...
                                            >
                                              ...
                                              >
                                                <span
                                                  className={`inline-flex px-2 py-1 rounded-full text-xs font-semibold ${getStatusColor(task.status) || ""}`}
                                                  style={{
                                                    whiteSpace: "normal",
                                                    ...getStatusStyles(
                                                      task.status,
                                        ...
                                        case "priority":
                                          ...
                                          return (
                                            ...
                                            >
                                              ...
                                              >
                                                <span
                                                  className={`inline-block px-2 py-1 rounded-4xl text-xs font-semibold ${getPriorityColor(task.priority)}`}
                                                >
                                                  {getCurrentPriorityOptions().find(
                                                    (opt) =>
                                                      opt.value ===
                                                      task.priority,
                                                  )?.label || task.priority}
                                                  ...
                                                  >
                                                    {getCurrentPriorityOptions().map(
                                                      (opt) => (
                                                        ...
                                                        >
                                                          <span
                                                            className={`inline-block px-2 py-1 rounded-full text-xs font-semibold ${getPriorityColor(opt.value)}`}
                                                          >
                                                            {opt.label}
                                                          </span>
                                                          {task.priority ===
                                        ...
                                        case "verification":
                                          ...
                                          return (
                                            ...
                                            >
                                              ...
                                              >
                                                <span
                                                  className={`inline-block px-2 py-1 rounded-full text-xs font-semibold ${getVerificationColor(task.verification || "pending")}`}
                                                >
                                                ...
                                                ReactDOM.createPortal(
                                                  ...
                                                  >
                                                    {getVerificationOptions(
                                                      ...
                                                      >
                                                        <span
                                                          className={`inline-block px-2 py-1 rounded-full text-xs font-semibold ${getVerificationColor(opt.value)}`}
                                                        >
                                                          {opt.label}
                                                        </span>
                                                        {(task.verification ||
                                                    ...
                                                    canEditSelfVerification
                                                      ? async (e) => {
                                                          ...
                                                          try {
                                                            ...
                                                            if (!response.ok)
                                                              throw new Error(
                                                                "Failed to update self verification",
                                                              );
                                                            const updatedTask =
                                                              await response.json();
                                                            console.log(
                                                            ...
                                                            console.error(
                                                              "Error updating self verification:",
                                                              err,
                                                            );
                                                            toast.error(
                                                              "Failed to update Self Verification",
                                        ...
                                        case "fifthVerificationAssignedTo": {
                                          ...
                                          const colIdx =
                                            verifierFields.indexOf(colId);
                                          const currVerifierField =
                                            verifierFields[colIdx];
                                          const prevVerifierField =
                                            verifierFields[colIdx - 1];
                                          ...
                                          let userIsThisVerifier =
                                            task[currVerifierField]?._id ===
                                            currentUser?._id;
                                          let userIsPrevVerifier =
                                            colIdx > 0 &&
                                            task[prevVerifierField]?._id ===
                                              currentUser?._id &&
                                            !task[currVerifierField];
                                          ...
                                          if (
                                            ...
                                            let latestNonEmptyVerifierIndex =
                                              -1;
                                            for (
                                              let i = verifierFields.length - 1;
                                              i >= 0;
                                              i--
                                            ) {
                                          ...
                                          if (
                                            ...
                                            if (
                                              colIdx ===
                                                nextEmptyVerifierIndex &&
                                              nextEmptyVerifierIndex !== -1
                                            ) {
                                              canEditThisVerifier = true;
                                            } else if (
                                              task.verification === "accepted"
                                          ...
                                          if (
                                            ...
                                            // For "next verification", allow assigning the next verifier in sequence
                                              ...
                                              const nextVerifierIndex =
                                                currentVerifierIndex + 1;
                                              if (
                                                colIdx === nextVerifierIndex &&
                                                nextVerifierIndex <
                                                  verifierFields.length
                                              ) {
                                                canEditThisVerifier = true;
                                              } else {
                                          ...
                                          const assignedVerifierIds =
                                            getAssignedVerifierIds(task);
                                          const dropdownUsers = users.filter(
                                            (u) =>
                                              u._id !== task.assignedTo?._id &&
                                              !assignedVerifierIds.includes(
                                                u._id,
                                              ) &&
                                                                ...
                                                                onClick={async (
                                                                  ...
                                                                  try {
                                                                    ...
                                                                    if (
                                                                      ...
                                                                      requestBody.verification =
                                                                        "pending";
                                                                    }

                                                                    const response =
                                                                      await fetch(
                                                                        `${API_BASE_URL}/api/tasks/${task._id}/verifier`,
                                                                        {
                                                                          method:
                                                                            "PATCH",
                                                                          headers:
                                                                    ...
                                                                    toast.error(
                                                                      `Failed to update ${col.label.toLowerCase()}`,
                                                                    );
                                                                  }
                                                                  setVerifierLoading(
                                                                    false,
                                          ...
                                          return (
                                            ...
                                            >
                                              <div
                                                className="overflow-x-auto whitespace-nowrap flex items-center"
                                                style={{
                                                  width: "100%",
                                                  maxWidth: "100%",
                                                }}
                                        ...
                                        case "guides":
                                          ...
                                          const guideChipsClass =
                                            viewType === "received" || isAdmin
                                              ? "pr-6"
                                              : "pr-0";
                                          const guideChipsMaxWidth =
                                            viewType === "received" || isAdmin
                                              ? "calc(100% - 28px)"
                                              : "100%";
                                          return (
                                            ...
                                            >
                                              ...
                                              >
                                                {/* Scrollable chips */}
                                                <div
                                                  className={`flex items-center gap-1 overflow-x-auto whitespace-nowrap ${guideChipsClass}`}
                                                  style={{
                                                    maxWidth:
                                                      guideChipsMaxWidth,
                                                  }}
                                                >
                                                  ...
                                                  task.guides.length > 0 ? (
                                                    task.guides.map((u) => (
                                                      <span
                                                        key={u._id}
                                                        className="flex items-center bg-blue-100 text-blue-800 rounded-full px-2 py-0.5 text-xs font-medium mr-1"
                                                      >
                                                        <img
                                                          src={
                                                            u?.photo?.url ||
                                                          ...
                                                          <button
                                                            ...
                                                            onClick={async (
                                                              ...
                                                              try {
                                                                const response =
                                                                  await fetch(
                                                                    `${API_BASE_URL}/api/tasks/${task._id}/guides`,
                                                                    {
                                                                      method:
                                                                        "PUT",
                                                                      headers: {
                                        ...
                                        default:
                                          ...
                                          if (colId.startsWith("custom_")) {
                                            const customColumnName =
                                              colId.replace("custom_", "");
                                            const columnDef =
                                              customColumns.find(
                                                (col) =>
                                                  col.name === customColumnName,
                                              );
                                            const customValue =
                                              task.customFields?.[
                                                customColumnName
                  ...
                  : tasksToUse.slice(0, loadedTasksCount).map((task, idx) => (
                      <tr
                        ...
                        onDragEnd={handleRowDragEnd}
                        style={{
                          opacity: draggedTaskId === task._id ? 0.5 : 1,
                        }}
                      >
                        {enableBulkSelection && (
                          <td
                          ...
                          switch (colId) {
                            ...
                            case "description":
                              return (
                                <td
                                  ...
                                  style={{
                                    verticalAlign: "top",
                                    width: (columnWidths[colId] || 180) + "px",
                                    minWidth:
                                      (columnWidths[colId] || 180) + "px",
                                    maxWidth:
                                      (columnWidths[colId] || 180) + "px",
                                    background: "white",
                                    overflow: "visible",
                            ...
                            case "billed":
                              return (
                                <td
                                  ...
                                  className={`px-2 py-1 text-sm font-normal align-middle bg-white ${!isLast ? "border-r border-gray-200" : ""}`}
                                  style={{
                                    width: (columnWidths[colId] || 80) + "px",
                                    minWidth:
                                      (columnWidths[colId] || 80) + "px",
                                    maxWidth:
                                      (columnWidths[colId] || 80) + "px",
                                    background: "white",
                                    overflow: "hidden",
                              ...
                              return (
                                <td
                                  ...
                                  style={{
                                    ...
                                    position: "relative",
                                    zIndex:
                                      editingPriorityTaskId === task._id
                                        ? 50
                                        : "auto",
                                  }}
                                  onClick={(e) => {
                              ...
                              return (
                                <td
                                  ...
                                  style={{
                                    ...
                                    position: "relative",
                                    zIndex:
                                      editingVerificationTaskId === task._id
                                        ? 50
                                        : "auto",
                                  }}
                                  onClick={(e) => {
                            ...
                            case "fifthVerificationAssignedTo": {
                              ...
                              if (
                                ...
                                if (
                                  latestNonEmptyVerifierIndex !== -1 &&
                                  colIdx === latestNonEmptyVerifierIndex
                                ) {
                                  canEditThisVerifier = true;
                              ...
                              if (taskType === "receivedVerification") {
                                ...
                                // For "next verification", allow assigning the next verifier in sequence
                                  ...
                                  task.verification === "next verification"
                                ) {
                                  // Find current verifier
                                  let currentVerifierIndex = -1;
                                  ...
                                  if (
                                    colIdx === nextVerifierIndex &&
                                    nextVerifierIndex < verifierFields.length
                                  ) {
                                    canEditThisVerifier = true;
                                  } else {
                                    canEditThisVerifier = false;
                              ...
                              const dropdownUsers = users.filter(
                                (u) =>
                                  ...
                                  `${u.firstName} ${u.lastName}`
                                    .toLowerCase()
                                    .includes(verifierSearch.toLowerCase()),
                              );
                                              ...
                                              dropdownUsers.map((u) => (
                                                <div
                                                  ...
                                                  style={{
                                                    ...
                                                    background:
                                                      task[colId] &&
                                                      task[colId]._id === u._id
                                                        ? "#f3f4f6"
                                                        : "transparent",
                                                    marginBottom: 2,
                                                    transition:
                                                      "background 0.15s",
                                                    opacity: verifierLoading
                                                      ? 0.6
                                                      : 1,
                                                  }}
                                                  onClick={async (e) => {
                            ...
                            case "guides":
                              ...
                              return (
                                <td
                                  ...
                                  className={`px-2 py-1 text-sm font-normal align-middle bg-white ${!isLast ? "border-r border-gray-200" : ""}`}
                                  style={{
                                    width: (columnWidths[colId] || 200) + "px",
                                    minWidth:
                                      (columnWidths[colId] || 200) + "px",
                                    maxWidth:
                                      (columnWidths[colId] || 200) + "px",
                                    background: "white",
                                    overflow: "hidden",
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <div
                                      className={`flex items-center gap-1 overflow-x-auto whitespace-nowrap ${guideChipsClass}`}
                                      style={{ maxWidth: guideChipsMaxWidth }}
                                    >
                                      {Array.isArray(task.guides) &&
                                      task.guides.length > 0 ? (
                                        task.guides.map((u) => (
                                    ...
                                    {/* Dropdown for selecting guides */}
                                    {viewType === "received" &&
                                      openGuideDropdownTaskId === task._id &&
                                      ReactDOM.createPortal(
                                        <div
                                          ref={guideDropdownRef}
                                          style={{
                            ...
                            default:
                              // Check if this is a custom column
                              if (colId.startsWith("custom_")) {
                                const customColumnName = colId.replace(
                                  "custom_",
                                  "",
                                );
                                const columnDef = customColumns.find(
                                  (col) => col.name === customColumnName,
                                );
                                const customValue =
                                  task.customFields?.[customColumnName];
          ...
          {showDeleteDropdown && (
            ...
            >
              <button
                onClick={() => {
                  const task =
                    tasksToUse.find((t) => t._id === showDeleteDropdown) ||
                ...
                className="w-full px-3 py-2 text-left text-sm text-blue-600 hover:bg-blue-50 hover:text-blue-800 transition-colors flex items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  automations.map((automation) => (
                    <button
                      ...
                      onClick={() => {
                        const task =
                          tasksToUse.find(
                            (t) => t._id === showAutomationDropdown,
                          ) ||
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-400 mt-1">
                        ...
                        {automation.triggerType === "dayOfMonth" &&
                          ` (Day ${automation.dayOfMonth})`}
                      </div>
                    </button>
                  ))
                ) : (
