              ...
              <tr key={todo._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getPriorityColor(todo.priority)}`}>
                    {todo.priority.replace(/([A-Z])/g, ' $1').trim()}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <button
                    onClick={() => handleStatusChange(todo._id, todo.status)}
                    className={`px-2 py-1 text-xs leading-5 font-semibold rounded-full ${getStatusColor(todo.status)}`}
                  >
            ...
            <form onSubmit={handleSubmit} className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  required
                >
                  <option value="inOneWeek">In one week</option>
                  <option value="inFifteenDays">In 15 days</option>
                  <option value="inOneMonth">In one month</option>
