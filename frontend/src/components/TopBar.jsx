    ...
    <header className="w-full h-16 bg-white shadow flex items-center px-4 sm:px-6 justify-between">
      ...
      <div className="flex items-center">
        ...
        <div className="flex flex-col justify-center">
          <span className="text-xl md:text-xl mb-1 text-gray-800 leading-tight">
            Hari Agarwal & Associates
          </span>
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            />
            <span className="ml-2 text-sm md:text-base font-normal text-gray-800 hidden sm:inline">
