...
const UserAnalytics = ({ userId, userName, onClose }) => {
  ...
  const taskBreakdownData = {
    labels: analytics.taskBreakdown
      .slice(0, 8)
      .map(
        (task) =>
          task.task?.title?.substring(0, 20) +
            (task.task?.title?.length > 20 ? "..." : "") || "Unknown Task",
      ),
    datasets: [
      {
        data: analytics.taskBreakdown
          .slice(0, 8)
          .map((task) => task.totalMinutes / 60),
        backgroundColor: [
          "#3B82F6",
          "#10B981",
          "#F59E0B",
      ...
      <div className="bg-white shadow-2xl w-full h-full sm:w-[95vw] sm:max-w-7xl overflow-hidden pb-36 border border-gray-200 sm:rounded-lg">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-gray-600 text-sm sm:text-base font-medium truncate">
                  {analytics.user.role}
                </p>
                ...
                <p className="text-gray-400 text-xs mt-1 truncate">
                  Team: {analytics.user.team || "Not assigned"}
                </p>
              </div>
            </div>
        ...
        <div className="h-full overflow-y-auto p-3 sm:p-6 bg-gray-50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-3 sm:p-4 border-l-4 border-green-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-green-900 mt-1">
                    {formatTime(analytics.summary.totalWorkingHours)}
                  </div>
                  <div className="text-green-600 text-xs mt-1">
                    {formatTimeDecimal(analytics.summary.totalWorkingHours)}h
                    decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-3 sm:p-4 border-l-4 border-indigo-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-indigo-700 text-xs font-semibold uppercase tracking-wide">
                    TOTAL SALARY
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-indigo-900 mt-1">
                    ₹
                    {analytics.summary.totalSalary
                      ? analytics.summary.totalSalary.toFixed(2)
                      : "0.00"}
                  </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-3 sm:p-4 border-l-4 border-teal-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-teal-900 mt-1">
                    {formatTime(analytics.summary.taskHours)}
                  </div>
                  <div className="text-teal-600 text-xs mt-1">
                    {formatTimeDecimal(analytics.summary.taskHours)}h decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-3 sm:p-4 border-l-4 border-red-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-red-700 text-xs font-semibold uppercase tracking-wide">
                    PERMISSION
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-red-900 mt-1">
                    {formatTime(analytics.summary.permissionHours)}
                  </div>
                  <div className="text-red-600 text-xs mt-1">
                    {formatTimeDecimal(analytics.summary.permissionHours)}h
                    decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-3 sm:p-4 border-l-4 border-yellow-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-yellow-700 text-xs font-semibold uppercase tracking-wide">
                    LUNCH BREAK
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-yellow-900 mt-1">
                    {formatTime(analytics.summary.lunchHours)}
                  </div>
                  <div className="text-yellow-600 text-xs mt-1">
                    {formatTimeDecimal(analytics.summary.lunchHours)}h decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-3 sm:p-4 border-l-4 border-blue-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-blue-900 mt-1">
                    {formatTime(analytics.summary.billingHours)}
                  </div>
                  <div className="text-blue-600 text-xs mt-1">
                    {formatTimeDecimal(analytics.summary.billingHours)}h decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-3 sm:p-4 border-l-4 border-purple-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-purple-900 mt-1">
                    {formatTime(analytics.summary.otherHours)}
                  </div>
                  <div className="text-purple-600 text-xs mt-1">
                    {formatTimeDecimal(analytics.summary.otherHours)}h decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-3 sm:p-4 border-l-4 border-indigo-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-indigo-900 mt-1">
                    {formatTime(analytics.summary.infrastructureHours || 0)}
                  </div>
                  <div className="text-indigo-600 text-xs mt-1">
                    {formatTimeDecimal(
                      analytics.summary.infrastructureHours || 0,
                    )}
                    h decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 p-3 sm:p-4 border-l-4 border-emerald-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-emerald-900 mt-1">
                    {formatTime(
                      analytics.summary.discussionWithVivekHours || 0,
                    )}
                  </div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-3 sm:p-4 border-l-4 border-pink-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-pink-700 text-xs font-semibold uppercase tracking-wide">
                    AVG DAILY
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-pink-900 mt-1">
                    {formatTimeDecimal(
                      analytics.productivity.averageDailyHours,
                    )}
                    h
                  </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-3 sm:p-4 border-l-4 border-orange-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-orange-700 text-xs font-semibold uppercase tracking-wide">
                    HOURLY RATE
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-orange-900 mt-1">
                    ₹{analytics.user.hourlyRate || 0}
                  </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 p-3 sm:p-4 border-l-4 border-emerald-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-emerald-900 mt-1">
                    {formatTime(analytics.summary.billedTaskHours || 0)}
                  </div>
                  <div className="text-emerald-600 text-xs mt-1">
                    {formatTimeDecimal(analytics.summary.billedTaskHours || 0)}h
                    decimal
                  </div>
                </div>
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-emerald-500 flex items-center justify-center rounded flex-shrink-0">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-rose-100 p-3 sm:p-4 border-l-4 border-rose-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-rose-700 text-xs font-semibold uppercase tracking-wide">
                    UNBILLED TASKS
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-rose-900 mt-1">
                    {formatTime(analytics.summary.unbilledTaskHours || 0)}
                  </div>
                  <div className="text-rose-600 text-xs mt-1">
                    {formatTimeDecimal(
                      analytics.summary.unbilledTaskHours || 0,
                    )}
                    h decimal
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-3 sm:p-4 border-l-4 border-cyan-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-cyan-700 text-xs font-semibold uppercase tracking-wide whitespace-nowrap">
                    APPROVED
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-cyan-900 mt-1">
                    {analytics.leaveDays?.approved || 0} days
                  </div>
                  <div className="text-cyan-600 text-xs mt-1">leave days</div>
                </div>
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-cyan-500 flex items-center justify-center rounded flex-shrink-0">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-white"
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-3 sm:p-4 border-l-4 border-amber-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-amber-700 text-xs font-semibold uppercase tracking-wide whitespace-nowrap">
                    PENDING
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-amber-900 mt-1">
                    {analytics.leaveDays?.pending || 0} days
                  </div>
                  <div className="text-amber-600 text-xs mt-1">leave days</div>
                </div>
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-amber-500 flex items-center justify-center rounded flex-shrink-0">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-white"
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-3 sm:p-4 border-l-4 border-red-500 shadow-sm min-h-[100px]">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  <div className="text-red-700 text-xs font-semibold uppercase tracking-wide whitespace-nowrap">
                    REJECTED
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-red-900 mt-1">
                    {analytics.leaveDays?.rejected || 0} days
                  </div>
                  <div className="text-red-600 text-xs mt-1">leave days</div>
                </div>
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-red-500 flex items-center justify-center rounded flex-shrink-0">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-white"
              ...
              <div className="max-h-64 sm:max-h-96 overflow-y-auto">
                <table className="w-full text-xs sm:text-sm">
                  <thead className="bg-gray-50 sticky top-0">
                    <tr>
                      <th className="text-left p-2 sm:p-3 font-semibold text-gray-700 border-b border-gray-200">
                        Task
                      </th>
                      <th className="text-right p-2 sm:p-3 font-semibold text-gray-700 border-b border-gray-200">
                        Time
                      </th>
                    </tr>
                  </thead>
                        ...
                        <td className="p-2 sm:p-3">
                          <div className="font-medium text-gray-900 text-xs sm:text-sm">
                            ...
                            {task.task?.clientName && (
                              <span
                                className="text-xs text-gray-500 truncate block mt-1"
                                title={task.task.clientName}
                              >
              ...
              <div className="space-y-3 sm:space-y-4">
                {analytics.productivity.mostProductiveDay && (
                  <div className="bg-gradient-to-r from-green-50 to-green-100 border-l-4 border-green-500 p-3 sm:p-4 rounded">
                    <div className="font-semibold text-green-800 text-xs uppercase tracking-wide">
                      Most Productive Day
                    </div>
                    <div className="text-green-700 font-medium mt-1 text-sm sm:text-base">
                      {format(
                        parseISO(analytics.productivity.mostProductiveDay.date),
                        "MMMM dd, yyyy",
                      )}
                    </div>
                    <div className="text-lg sm:text-xl font-bold text-green-900 mt-1">
                      {formatTime(
                        analytics.productivity.mostProductiveDay.workingHours,
                      )}
                    </div>
                  </div>
                )}
                ...
                {analytics.productivity.leastProductiveDay && (
                  <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-l-4 border-yellow-500 p-3 sm:p-4 rounded">
                    <div className="font-semibold text-yellow-800 text-xs uppercase tracking-wide">
                      Least Productive Day
                    </div>
                    <div className="text-yellow-700 font-medium mt-1 text-sm sm:text-base">
                      {format(
                        parseISO(
                          analytics.productivity.leastProductiveDay.date,
                        ),
                        "MMMM dd, yyyy",
                      )}
                    </div>
                    <div className="text-lg sm:text-xl font-bold text-yellow-900 mt-1">
                      {formatTime(
                        analytics.productivity.leastProductiveDay.workingHours,
                      )}
                    </div>
                  </div>
                )}
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 border-l-4 border-gray-500 p-3 sm:p-4 rounded">
                  ...
                  <div className="text-gray-700 font-medium mt-1 text-sm sm:text-base">
                    {format(parseISO(analytics.dateRange.start), "MMM dd")} -{" "}
                    {format(parseISO(analytics.dateRange.end), "MMM dd, yyyy")}
                  </div>
                  <div className="text-xs sm:text-sm text-gray-600 mt-1">
                    {differenceInDays(
                      parseISO(analytics.dateRange.end),
                      parseISO(analytics.dateRange.start),
                    ) + 1}{" "}
                    days analyzed
                  </div>
                </div>
