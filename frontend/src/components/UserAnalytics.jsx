...
const UserAnalytics = ({ userId, userName, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/25 bg-opacity-95 flex items-center justify-center z-50 p-6">
      <div className="bg-white shadow-2xl w-[95vw] h-[90vh] max-w-7xl overflow-hidden border border-gray-200">
        {/* Header */}
        <div className="bg-white border-b border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-1">{analytics.user.name}</h2>
                <p className="text-gray-600 text-base font-medium">{analytics.user.role}</p>
                <p className="text-gray-500 text-sm">{analytics.user.email}</p>
                <p className="text-gray-400 text-xs mt-1">Team: {analytics.user.team || 'Not assigned'}</p>
              </div>
            </div>
            
            {/* Date Range Selector */}
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <input
                    ...
                    className="bg-white text-gray-800 border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                <div className="flex items-center space-x-2">
              ...
              <button
                onClick={onClose}
                className="bg-red-500 hover:bg-red-600 p-2 rounded transition-all duration-200 border border-red-400 hover:border-red-500"
                title="Close"
              >
        ...
        <div className="h-full overflow-y-auto p-6 bg-gray-50">
          ...
          <div className="grid grid-cols-6 gap-4 mb-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 border-l-4 border-green-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-green-700 text-xs font-semibold uppercase tracking-wide">TOTAL WORKING</div>
                  <div className="text-2xl font-bold text-green-900 mt-1">{formatTime(analytics.summary.totalWorkingHours)}</div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 border-l-4 border-indigo-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-indigo-700 text-xs font-semibold uppercase tracking-wide">TOTAL SALARY</div>
                  <div className="text-2xl font-bold text-indigo-900 mt-1">₹{analytics.summary.totalSalary ? analytics.summary.totalSalary.toFixed(2) : '0.00'}</div>
                  <div className="text-indigo-600 text-xs mt-1">for selected period</div>
                </div>
                <div className="w-10 h-10 bg-indigo-500 flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-4 border-l-4 border-teal-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-teal-700 text-xs font-semibold uppercase tracking-wide">TASK HOURS</div>
                  <div className="text-2xl font-bold text-teal-900 mt-1">{formatTime(analytics.summary.taskHours)}</div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-4 border-l-4 border-red-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-red-700 text-xs font-semibold uppercase tracking-wide">PERMISSION</div>
                  <div className="text-2xl font-bold text-red-900 mt-1">{formatTime(analytics.summary.permissionHours)}</div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-4 border-l-4 border-yellow-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-yellow-700 text-xs font-semibold uppercase tracking-wide">LUNCH BREAK</div>
                  <div className="text-2xl font-bold text-yellow-900 mt-1">{formatTime(analytics.summary.lunchHours)}</div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 border-l-4 border-blue-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-blue-700 text-xs font-semibold uppercase tracking-wide">BILLING</div>
                  <div className="text-2xl font-bold text-blue-900 mt-1">{formatTime(analytics.summary.billingHours)}</div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 border-l-4 border-purple-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-purple-700 text-xs font-semibold uppercase tracking-wide">OTHER</div>
                  <div className="text-2xl font-bold text-purple-900 mt-1">{formatTime(analytics.summary.otherHours)}</div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-4 border-l-4 border-pink-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-pink-700 text-xs font-semibold uppercase tracking-wide">AVG DAILY</div>
                  <div className="text-2xl font-bold text-pink-900 mt-1">{formatTimeDecimal(analytics.productivity.averageDailyHours)}h</div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 border-l-4 border-orange-500 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-orange-700 text-xs font-semibold uppercase tracking-wide">HOURLY RATE</div>
                  <div className="text-2xl font-bold text-orange-900 mt-1">₹{analytics.user.hourlyRate || 0}</div>
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white shadow-lg border border-gray-200 p-5">
              ...
              <div className="max-h-48 overflow-y-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 sticky top-0">
                    <tr>
                      <th className="text-left p-3 font-semibold text-gray-700 border-b border-gray-200">Task</th>
                      <th className="text-right p-3 font-semibold text-gray-700 border-b border-gray-200">Time</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="bg-white shadow-lg border border-gray-200 p-5">
              ...
              <div className="space-y-4">
                {analytics.productivity.mostProductiveDay && (
                  <div className="bg-gradient-to-r from-green-50 to-green-100 border-l-4 border-green-500 p-4">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 border-l-4 border-gray-500 p-4">
