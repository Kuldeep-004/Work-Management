...
import TaskReport from "./dashboard/TaskReport";
    ...
    return (
      <DashboardLayout>
        <Routes>
          ...
          <Route
            path="subordinate-timesheets"
            element={<SubordinateTimesheets />}
          />
  ...
  return (
    <DashboardLayout>
      <Routes>
        ...
        {(Array.isArray(user?.role2)
          ? user.role2.includes("TimeSheet Verifier")
          : user?.role2 === "TimeSheet Verifier") && (
          <Route
            path="subordinate-timesheets"
            element={<SubordinateTimesheets />}
          />
